...
public class MyTypeToken<T> {
    ...
    protected MyTypeToken() {
        ...
        this.rawType = null;//Types.getRawType(this.type);
...
//        return o instanceof MyTypeToken && Types.equals(this.type, ((MyTypeToken)o).type);
//    }
//
...
//    }
//
//    public static MyTypeToken<?> get(Type type) {
//        return new MyTypeToken(type);
//    }
//
//    public static <T> MyTypeToken<T> get(Class<T> type) {
//        return new MyTypeToken(type);
//    }
//
//    public static MyTypeToken<?> getParameterized(Type rawType, Type... typeArguments) {
//        return new MyTypeToken(Types.newParameterizedTypeWithOwner((Type)null, rawType, typeArguments));
//    }
//
//    public static MyTypeToken<?> getArray(Type componentType) {
//        return new MyTypeToken(Types.arrayOf(componentType));
//    }
}
